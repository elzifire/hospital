...
@section('page-title', 'Tambah Pesan Masuk')
...
<div class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        <nav class="mb-2 flex items-center gap-1.5 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
            ...
            <span class="font-semibold text-slate-600">Tambah Pesan</span>
        </nav>
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Tambah Pesan Masuk</h2>
        <p class="mt-0.5 text-sm text-slate-500">Catat balasan WhatsApp dari PNPP secara manual.</p>
    </div>
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div>
                        ...
                        <input type="text" placeholder="081234567890" class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition">
                    </div>
                    ...
                    <div>
                        ...
                        <textarea rows="3" placeholder="cth. Ya, saya akan datang." class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition"></textarea>
                    </div>
