...
@section('title', 'Kirim Pesan Outreach')
@section('page-title', 'Kirim Pesan Outreach')

@section('content')
<div x-data="outreachForm()" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        <nav class="mb-2 flex items-center gap-1.5 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
            ...
            <span class="font-semibold text-slate-600">Kirim Pesan</span>
        </nav>
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Kirim Pesan Outreach</h2>
        <p class="mt-0.5 text-sm text-slate-500">Pilih satker, pilih PNPP atau grouping, lalu atur pesan WhatsApp yang akan dikirim.</p>
    </div>
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Cari dan pilih satuan kerja sasaran pesan.</p>
                </div>
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div x-show="mode === 'pnpp' && satkerId !== null" x-cloak>
                        ...
                        <p class="mt-2 text-xs text-slate-400"><span x-text="pilih.length"></span> penerima dipilih.</p>
                    </div>
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <ul class="divide-y divide-slate-50">
                    ...
                    <li class="flex items-center justify-between px-5 py-3.5">
                        ...
                        <span class="text-sm font-bold text-slate-800" x-text="modeKirim === 'sekarang' ? 'Sekarang' : 'Terjadwal'"></span>
                    </li>
                </ul>
            </div>
