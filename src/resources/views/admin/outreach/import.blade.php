    ...
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex items-center justify-end gap-3">
                <a href="{{ route('admin.outreach.index') }}" class="rounded-xl border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-xs transition hover:bg-slate-50">Kembali</a>
