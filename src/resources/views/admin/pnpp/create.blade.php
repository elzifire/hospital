...
@section('title', 'Tambah PNPP')
@section('page-title', 'Tambah PNPP')
...
<div x-data="pnppForm()" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        ...
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Tambah Data PNPP</h2>
        <p class="mt-0.5 text-sm text-slate-500">Lengkapi identitas pegawai/pegawai dan riwayat kesehatannya.</p>
    </div>

    <form action="{{ route('admin.pnpp.store') }}" method="POST" @submit="saving = true" x-cloak>
        @csrf
            ...
            <div class="space-y-6 lg:col-span-2">
                    ...
                    <div class="space-y-5 p-6">
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                            <div class="sm:col-span-2">
                                ...
                                <input type="text" name="nama" id="nama" value="{{ old('nama') }}" x-model="nama" required placeholder="cth. Budi Santoso"
                            ...
                            <div>
                                ...
                                <input type="text" name="nip" id="nip" value="{{ old('nip') }}" x-model="nip" required placeholder="18 digit NIP"
                            ...
                            <div>
                                ...
                                <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp') }}" x-model="noHp" placeholder="cth. 081234567890" required
                            ...
                            <div>
                                ...
                                <input type="date" name="tanggal_lahir" id="tanggal_lahir" value="{{ old('tanggal_lahir') }}" x-model="tanggalLahir"
                ...
                <div class="flex items-center justify-end gap-3">
                    ...
                    <button type="submit" :disabled="saving"
                        ...
                        <span x-text="saving ? 'Menyimpan...' : 'Simpan PNPP'"></span>
                    </button>
                </div>
            </div>
...
<script>
    document.addEventListener('alpine:init', () => {
        Alpine.data('pnppForm', () => ({
            ...
            penyakitMenahun: @js(old('penyakit_menahun', [])),
            saving: false,
