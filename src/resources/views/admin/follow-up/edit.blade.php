...
@section('content')
<div x-data="followUpForm(true)" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        <nav class="mb-2 flex items-center gap-1.5 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
            ...
            <span class="font-semibold text-slate-600">Edit Follow Up</span>
        </nav>
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Edit Follow Up</h2>
        <p class="mt-0.5 text-sm text-slate-500">Perbarui sasaran, pesan pengingat ulang, dan jadwal kirim.</p>
    </div>
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Perbarui isi pengingat ulang WhatsApp dan waktu pengirimannya.</p>
                </div>
...
<script>
    function followUpForm(prefill = false) {
        return {
