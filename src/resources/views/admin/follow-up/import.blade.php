...
@section('title', 'Import Follow Up')
@section('page-title', 'Import Follow Up')

@section('content')
@php
    $headers = ['Nama', 'NIP/NRP', 'Prioritas', 'Jadwal', 'Petugas'];
    $rows = [
        ['Budi Santoso', '198501012010011001', 'Tinggi', '2026-09-02 14:00', 'Ayu Lestari'],
        ['Siti Aminah',  '199003152015122002', 'Sedang', '2026-09-02 15:00', 'Bimo Saputra'],
        ['Agus Wijaya',  '197812302008121003', 'Tinggi', '2026-09-02 16:00', 'Citra Dewi'],
    ];
@endphp
<div class="mx-auto max-w-5xl space-y-6">
    ...
    <div>
        ...
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Import Follow Up</h2>
        <p class="mt-0.5 text-sm text-slate-500">Unggah file Excel/CSV untuk membuat banyak tindak lanjut sekaligus.</p>
    </div>
    ...
    <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
        ...
        <div class="p-6">
            ...
            <div class="mt-6 flex items-center justify-end gap-3">
                <a href="{{ route('admin.follow-up.index') }}" class="rounded-xl border border-slate-300 bg-white px-5 py-2.5 text-sm font-semibold text-slate-700 shadow-xs transition hover:bg-slate-50">Kembali</a>
