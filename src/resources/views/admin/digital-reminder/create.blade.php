...
<div x-data="{ mode: 'individu', cariP: '', cariS: '', pilih: [], pilihSatker: [] }" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        ...
        <p class="mt-0.5 text-sm text-slate-500">Buat pengingat broadcast WhatsApp H-7 untuk PNPP.</p>
    </div>
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div>
                            ...
                            <input type="datetime-local" class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition">
                        </div>
                        <div>
