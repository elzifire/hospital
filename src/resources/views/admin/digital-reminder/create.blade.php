...
@section('page-title', 'Tambah Reminder')

@section('content')
<div x-data="reminderForm()" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        <nav class="mb-2 flex items-center gap-1.5 text-xs font-medium text-slate-400" aria-label="Breadcrumb">
            ...
            <span class="font-semibold text-slate-600">Tambah Reminder</span>
        </nav>
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Tambah Reminder</h2>
        <p class="mt-0.5 text-sm text-slate-500">Pilih satker, pilih PNPP, lalu jadwalkan ke satu atau beberapa instalasi.</p>
    </div>
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Cari dan pilih satuan kerja.</p>
                </div>
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Ambil dari database PNPP satker terpilih, atau gunakan Pilih Semua.</p>
                </div>
                ...
                <div class="space-y-5 p-6">
                    ...
                    <div x-show="mode === 'pnpp' && satkerId !== null" x-cloak>
                        ...
                        <p class="mt-2 text-xs text-slate-400"><span x-text="pilih.length"></span> pasien dipilih — 1 pasien bisa dijadwalkan ke beberapa instalasi.</p>
                    </div>
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    <h3 class="flex items-center gap-2.5 text-base font-bold text-slate-900">
                        ...
                        Jadwal Kunjungan & Instalasi
                    </h3>
                    <p class="mt-0.5 text-sm text-slate-500">Satu pasien bisa dijadwalkan ke beberapa instalasi. Home visit bersifat opsional.</p>
                </div>
                    ...
                    <template x-for="pasien in pilih" :key="pasien.id">
                        <div class="rounded-xl ring-1 ring-slate-200">
                            ...
                            <div class="space-y-4 p-4">
                                {{-- Instalasi (bisa pilih beberapa) --}}
                                <div>
                                    <p class="mb-2 text-xs font-bold uppercase tracking-wide text-slate-500">Instalasi Tujuan <span class="text-slate-400 normal-case font-medium">(bisa lebih dari satu)</span></p>
                                    <div class="flex flex-wrap gap-2">
                                        ...
                                        <p x-show="polis.length === 0" class="text-xs text-slate-400">Belum ada data instalasi.</p>
                                    </div>
                                </div>
        ...
        <div class="space-y-6 lg:col-span-1">
            ...
            <div class="overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <ul class="divide-y divide-slate-50">
                    ...
                    <li class="flex items-center justify-between px-5 py-3.5">
                        <span class="text-sm font-medium text-slate-500">Total jadwal Instalasi</span>
