...
@endphp
<div x-data="{ mode: 'individu', cariP: '', cariS: '', pilih: ['Budi Santoso'], pilihSatker: [] }" class="mx-auto max-w-6xl space-y-6">
    ...
    <div>
        ...
        <p class="mt-0.5 text-sm text-slate-500">Perbarui pengingat broadcast WhatsApp H-7.</p>
    </div>
        ...
        <div class="space-y-6 lg:col-span-2">
            ...
            <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                <div class="border-b border-slate-100 p-6">
                    ...
                    <p class="mt-0.5 text-sm text-slate-500">Pesan akan dikirim otomatis H-7 sebelum jadwal.</p>
                </div>
                ...
                <div class="space-y-5 p-6">
                    <div class="flex items-center gap-2 rounded-xl bg-emerald-50/70 p-3 ring-1 ring-emerald-100">
                        ...
                        <span class="text-xs font-semibold text-emerald-700">Dikirim melalui <strong>WhatsApp</strong> (pengingat H-7).</span>
                    </div>

                    <div>
                        <label class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-500">Gunakan Template</label>
                        <select class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition cursor-pointer">
                            <option>Pengingat Kontrol</option>
                            <option>Pengingat Minum Obat</option>
                    ...
                    <div>
                        ...
                        <textarea rows="3" class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 placeholder:text-slate-400 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition">Halo {nama}, Anda memiliki jadwal kunjungan di {poli} pada {tanggal}. Mohon hadir tepat waktu.</textarea>
                    </div>

                    <div class="grid grid-cols-1 gap-5 sm:grid-cols-2">
                        <div>
                            <label class="mb-1.5 block text-xs font-bold uppercase tracking-wide text-slate-500">Jadwal Kirim</label>
                            <input type="datetime-local" value="2026-09-03T07:30" class="block w-full rounded-xl border-0 py-2.5 px-3.5 text-sm text-slate-900 shadow-xs ring-1 ring-inset ring-slate-200 focus:ring-2 focus:ring-inset focus:ring-sky-500 transition">
                        </div>
                        <div>
            ...
            <div class="sticky top-20 overflow-hidden rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
                ...
                <div class="space-y-3 bg-[#e5ddd5] p-5">
                    <div class="ml-auto max-w-[85%] rounded-xl rounded-tr-sm bg-[#dcf8c6] p-3 shadow-sm">
                        <p class="text-sm text-slate-800">Halo Budi, Anda memiliki jadwal kunjungan di Poli Umum pada 05/09/2026. Mohon hadir tepat waktu.</p>
