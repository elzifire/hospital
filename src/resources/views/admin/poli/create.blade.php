...
<div x-data="{ saving: false }" class="mx-auto max-w-2xl space-y-6">
    ...
    <div>
        ...
        <h2 class="text-xl font-bold tracking-tight text-slate-900">Tambah Poli</h2>
        <p class="mt-0.5 text-sm text-slate-500">Daftarkan poliklinik baru.</p>
    </div>

    <form action="{{ route('admin.poli.store') }}" method="POST" @submit="saving = true" x-cloak>
        @csrf
        <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <div class="space-y-5 p-6">
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode') }}" placeholder="cth. GIGI"
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama') }}" required placeholder="cth. Poli Gigi"
            ...
            <div class="flex items-center justify-end gap-3 rounded-b-2xl border-t border-slate-100 bg-slate-50/70 p-4">
                ...
                <button type="submit" :disabled="saving"
                    ...
                    <span x-text="saving ? 'Menyimpan...' : 'Simpan Poli'"></span>
                </button>
            </div>
        </div>
    </form>
