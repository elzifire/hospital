...
<div class="space-y-6">
    @include('admin.monitoring.report.respon._header')
    @include('admin.monitoring.report.respon._stats')
    @include('admin.monitoring.report.respon._table')
    @include('admin.monitoring.report.respon._info')
</div>
@endsection