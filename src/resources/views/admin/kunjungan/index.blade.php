    ...
    <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
        <div class="border-b border-slate-100 px-5 py-4">
            ...
            <p class="mt-0.5 text-xs text-slate-500">
                Tabel detail per pasien &amp; tanggal — satu baris memperlihatkan poli mana saja yang dikunjungi dalam 1 hari kunjungan. Kartu <strong>Total Kunjungan</strong> dihitung per baris poli (satu pasien ke 3 poli dalam sehari = 3 kunjungan, ditampilkan 1 baris detail). <strong>Realisasi Reminder</strong> = kunjungan yang dicatat dari penjadwalan; <strong>Manual</strong> = catatan tanpa jadwal.
            </p>
        </div>
