        ...
        <div class="rounded-2xl bg-white shadow-sm ring-1 ring-slate-200">
            ...
            <div class="space-y-5 p-6">
                <div>
                    ...
                    <input type="text" name="kode" id="kode" value="{{ old('kode', $penyakit->kode) }}" placeholder="cth. HTN"
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $penyakit->nama) }}" required placeholder="cth. Hipertensi"
